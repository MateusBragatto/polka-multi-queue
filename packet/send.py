...
def main():
    ...
    pkt = pkt/IP(id=identification, src= get_if_addr('eth0'), dst='10.0.1.2', tos = 55)/UDP(dport=1234, sport=random.randint(49152,65535)) / sys.argv[1]  #adicionando um header de udp para evitar resposta ICMP
